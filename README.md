...
| macOS ARM | `sicth-aarch64-unknown-linux-gnu.tar.gz` |
| Windows x86_64 | `sicth-x86_64-pc-windows-msvc.zip` |
| AppImage | `sicth-1.1.0-x86_64.AppImage` |
...
### Debian/Ubuntu
```sh
sudo dpkg -i sicth_1.1.1-1_amd64.deb
```

### Fedora/RHEL
```sh
sudo rpm -i sicth-1.1.1-1.x86_64.rpm
```
